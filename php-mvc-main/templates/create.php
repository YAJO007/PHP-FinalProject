...
<div class="bg-white border-2 border-black rounded-[24px] 
    ...
    <div class="flex justify-between items-center 
        ...
        <div class="flex items-center gap-4 flex-wrap">
            ...
            <a href="my_event">
                <button class="px-6 py-2 bg-white border-2 border-black rounded-lg font-bold hover:bg-purple-100">
                    กิจกรรมของฉัน
                </button>
            </a>
        ...
        <button class="w-10 h-10 flex items-center justify-center 
                       bg-purple-600 text-white border-2 border-black rounded-md">
            ☰
        </button>
    </div>
    ...
    <div class="flex-1 bg-purple-100 p-10 flex justify-center">
        ...
        <div class="bg-white border-2 border-black rounded-[24px]
            ...
            <form method="POST" action="create_event" class="space-y-5">

                <div>
                    <label class="font-bold">ชื่อกิจกรรม</label>
                    <input name="title" required
                        class="w-full px-4 py-2 border-2 border-black rounded-lg shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]">
                </div>

                <div>
                    <label class="font-bold">รายละเอียดกิจกรรม</label>
                    <textarea name="detail" rows="3" required
                        class="w-full px-4 py-2 border-2 border-black rounded-lg shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]"></textarea>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="datetime-local" name="start_date"
                            class="w-full px-3 py-2 border-2 border-black rounded-lg bg-purple-100">
                    </div>
                ...
                <div class="flex gap-4 pt-4">
                    <button type="submit"
                        class="flex-1 bg-purple-600 text-white font-bold py-3 border-2 border-black rounded-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all">
                        สร้างกิจกรรม
                    </button>
 
                    <button type="reset"
                        class="flex-1 bg-white font-bold py-3 border-2 border-black rounded-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:bg-purple-100">
                        รีเซ็ต
                    </button>
                </div>
